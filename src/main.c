    ...
    #define LEDPORT (GPIOB)
    #define LED1 (15)
    #define ENABLE_GPIO_CLOCK (RCC->APB2ENR |= RCC_APB2ENR_IOPBEN_Msk)
    #define _MODER    CRH
    #define GPIOMODER (GPIO_CRH_MODE15_Msk)
#elif STM32F2
    #include "stm32f2xx.h"
    #define LEDPORT (GPIOB)
    #define LED1 (0)
...
int main(void)
{
    ...
    LEDPORT->_MODER |= GPIO_CRH_CNF15_0;   // set pins to be general purpose output
    for (;;) {
        ms_delay(500);
